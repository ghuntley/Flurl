...
namespace Flurl.Test
{
    ...
    public class UrlBuilderTests
    {
        ...
        {
            Url url = "http://www.mysite.com".AddQueryParams(new {x = 1, y = 2});
        ...
        public void can_add_multiple_query_params_from_dictionary()
        {
            ...
            Url url = "http://www.mysite.com".AddQueryParams(new Dictionary<int, string> {{1, "x"}, {2, "y"}});
        ...
        {
            Url url = "http://www.mysite.com".AddQueryParam("x", 1);
        ...
        public void can_append_multiple_path_segments_by_enumerable()
        {
            ...
            Url url = "http://www.mysite.com".AppendPathSegments(segments);
        ...
        {
            Url url = "http://www.mysite.com".AppendPathSegments("category", "endpoint");
            Assert.AreEqual("http://www.mysite.com/category/endpoint", url.ToString());
        }
        ...
        {
            Url url = "http://www.mysite.com".AppendPathSegment("endpoint");
        ...
        {
            Url url = "http://www.mysite.com/more?x=1&y=2".RemoveQueryParam("x");
        ...
        {
            Url url = "http://www.mysite.com/more?x=1&y=2".RemoveQueryParams(new[] {"x", "y"});
        ...
        {
            Url url = "http://www.mysite.com/more?x=1&y=2".RemoveQueryParams("x", "y");
            Assert.AreEqual("http://www.mysite.com/more", url.ToString());
        }
        ...
        {
            Url url = "http://www.mysite.com".AppendPathSegment("hey+there+how+are+ya");
        ...
        {
            Url url = "http://www.mysite.com".AddQueryParams(new {x = "$50", y = "2+2=4"});
